...
We wrote a script to evaluate the Clebsch Gordan coefficients for our system in order to see identify which of the possible $^2$P$_{3/2}$ states we are coupling to. The condition for an intermediate state to be valid is that its $F=5$
