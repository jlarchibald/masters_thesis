...
We can also motivate our use of the two state equations of motion using classic perturbation theory. If we take the standard time-dependent perturbation to second order, we get
\begin{equation}
