...
This allows us to calculate transition rates to specific hyperfine states in terms of the reduced dipole matrix elements that would be used for $L$ states.
...
\section{Looking up the reduced Dipole Moment Matrix Operator}
