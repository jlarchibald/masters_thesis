...
%
%First, we will discuss the states of our atom and the relevant quantum numbers. Second, we will start to examine the Hamiltonian, including various perturbations and adjustments that will be needed to make it complete. Next, we will discuss the interaction Hamiltonian by modelling the laser light as a classical radiation field. At this point, we will have shown that, after we have taken into account the complete Hamiltonian and the various selection rules and geometrical considerations, that there are really only three states 
...
% \cite{wikilandeg}: %could use this guy to approximate the dipole moment
%paschen bach? ehh, idk. 

%The derivation of this involves many of the concepts we have discussed in the previous section. However, in the interest of brevity, we simply quote the results from Ref.\,\cite{sobelman_spectra}: 
%%todo: cite wikipedia (!)
%%page 195
%
