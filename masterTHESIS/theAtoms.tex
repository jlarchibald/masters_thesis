...
Using the lookup for these\footnote{I will get this from Sobelman}, we see that the 
...
The standard way to write the hyperfine splitting is in terms of the hyperfine $A$ and $B$ coefficients. These are related to 
