...
However, before we perform these calculations, we would like to we would like to briefly pause and make the case for eliminating some of the states from our consideration in order to keep our equations manageable. 
...
Using the work of the previous sections, we can evaluate $-\frac{\langle i | \mathbf{d}\cdot \mathbf{E}_2 | e\rangle$
