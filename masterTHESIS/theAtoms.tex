...
\begin{align}
c_e(\tau)&=-i e^{-i(\delta \tau/2+\phi)} \frac{\Omega_{eg}}{\Omega_{r}} \sin\left(\frac{\Omega_r \tau}{2}\right)\\
...
|c_g(\tau)|^2&=1-\left(1-\frac{\delta^2}{\Omega_r^2}\right)\sin^2\left(\frac{\Omega_r \tau}{2}\right)
=1-()(1+\cos(\Omega_r\tau))
\end{align}

%should I put \Omega_r^2 just to see? No. 
for the total population in each state. 
Here, we define 
\begin{equation}
\end{equation}
\cite{Young1997363}
