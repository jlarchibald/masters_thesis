...
Evaluation of the Clebsch Gordan coefficients in Eq.\,\ref{wignerEckartForUs} eliminates most of the possible states.However, there are still many states that do couple. We quickly saw that there are a lot of different states that we could ostensibly drive with dipole radiation. In order to keep our equations manageable, we would like to briefly pause and make the case for eliminating some of the states from our consideration.
...
For the most part, we quote the results of Ref.\,\cite{Young1997363}. 

We have now identified three states and we can simplify the Hamiltonian of the system to 

\begin{equation}
H=\frac{\mathbf{p}}{2m} + 
\hbar\omega_1 |1\rangle\langle 1 | +
\hbar\omega_2 |2\rangle\langle 2 | +
\hbar\omega_i |i\rangle\langle i | -
\mathbf{d}\cdot\mathbf{E}
\end{equation}

where $\omega_1$ is the frequency of Slave 1, while $\omega_2$ is the frequency of Slave 2. 
