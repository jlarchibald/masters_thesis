...
\centering
\includegraphics[width=0.80\textwidth]{wavelength_selected.eps} 
\caption[Wavelength of different laser diodes]{\label{wavelengthselected} Representative data of the free-running (i.e. no grating feedback or extended cavity) wavelength of several wavelength selected lasers taken at 120 mA and 22.5$^\circ$C.} %temperature? %the ones we picked or someone else did? 
\end{figure}
