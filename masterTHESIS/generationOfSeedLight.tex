...
\caption[Photograph of Master Laser Diode]{\label{master_laser_interior_photo} The master laser in its housing..}
\end{subfigure}
\begin{subfigure}[b]{0.4\textwidth}
\includegraphics[width=1\textwidth]{diffractionGrating.JPG}
\caption[Photograph of Diffraction Grating]{\label{diffractionGratingPhoto} The diffraction grating before it is installed.}
\end{subfigure}
\caption[Photographs of Master Laser Components]{The master laser in its housing and the diffraction grating before it was installed. We modified the housing to include an additional temperature sensor (the AD592), which can be seen glued to the top of the copper plate}
